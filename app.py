...
st.markdown("""
    ...
    .apex-sidebar-brand .apex-brand-icon { font-size: 22px; line-height:1; }
    .apex-sidebar-brand .apex-brand-name {
        font-size: 17px; font-weight: 800; color: #eaecef; letter-spacing: .2px;
    }
    ...
    .apex-user-card {
        ...
        gap: 12px;
        padding: 14px 16px;
        background: linear-gradient(150deg, #181a20 0%, #12141a 100%);
    ...
    .apex-user-avatar {
        ...
        font-weight: 800; font-size: 16px; color: #0b0e11;
    }
    .apex-user-meta .apex-user-label {
        color: #5b6672; font-size: 10.5px; letter-spacing: .6px; text-transform: uppercase; font-weight: 700;
    }
    .apex-user-meta .apex-user-name {
        color: #fcd535; font-size: 15px; font-weight: 800; margin-top: 2px; line-height: 1.1;
    }
    .apex-user-meta .apex-user-status {
        color: #0ecb81; font-size: 11px; font-weight: 600; margin-top: 3px;
    }
    ...
    section[data-testid="stSidebar"] .stButton > button:hover {
        border-color: #f6465d;
        color: #f6465d;
        box-shadow: 0 6px 16px rgba(246,70,93,0.15);
    }
    ...
    section[data-testid="stSidebar"] div[role="radiogroup"] label:has(input:checked) {
        background: linear-gradient(90deg, rgba(252,213,53,0.14), rgba(252,213,53,0.02));
        border-color: #fcd535;
    }
    ...
    /* ============================================================
       MAIN-AREA HORIZONTAL RADIO GROUPS — PILL TABS
       ============================================================ */
    ...
    /* ============================================================
       GENERAL SPACING / ALIGNMENT POLISH
       ============================================================ */
    hr { margin: 20px 0 !important; border-color: #20262e !important; }
    .crypto-card h1, .crypto-card h2, .crypto-card h3 { margin-top: 0; }
...
if logo_path and os.path.exists(logo_path):
    ...
    st.sidebar.markdown(
        ...
        "<span class='apex-brand-icon'>⚡</span>"
        "<span class='apex-brand-name'>Apex Trading</span>"
        "</div>",
        unsafe_allow_html=True
    )

user_initial = curr_user[0].upper() if curr_user else "?"
st.sidebar.markdown(f"""
    <div class='apex-user-card'>
        <div class='apex-user-avatar'>{user_initial}</div>
        <div class='apex-user-meta'>
            <div class='apex-user-label'>Apex Trader</div>
            <div class='apex-user-name'>{curr_user}</div>
            <div class='apex-user-status'>● Active Session</div>
        </div>
    </div>
""", unsafe_allow_html=True)
...
st.sidebar.markdown("<div class='apex-nav-label'>Menu</div>", unsafe_allow_html=True)
config_menu = st.sidebar.radio(
    "Configs",
    ["📊 Dashboard", "🔌 Exchange Integration", "⚙️ Strategy Studio", "📦 Limitation & Campaign"],
    label_visibility="collapsed"
